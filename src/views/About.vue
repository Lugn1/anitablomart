...
<template>
  <div class="main-container">
    <h1>Om mig</h1>
    <div class="about">
      <p>Jag målar i akrylfärg och kallar mitt måleri halvabstrakt med figurativa inslag. Jag använder mig av en lager på lager metod.
        I målandets stunder får min själ en befriande distans till den stora världen och en slags meditativ vila infinner sig.
